                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                Adicionar produtos</h3>
                        </div>
                        <!-- /.card-header -->
                        <form action="<?php echo base_url(); ?>produtos/create" id="formProduto" method="post">
                            <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="DescricaoProduto" type="text" id="DescricaoProduto" class="form-control" placeholder="Descrição do produtos" required />
                                                            </div>
                                                        </div>
                                                    </div>                                               
                                                    <div class="row">
                                                                ...
                                                                <select name="CodigoProdutoGrupo" id="CodigoProdutoGrupo" class="form-control" required>
                                                                    ...
                                                                    if ($grupos) {
                                                                        foreach ($grupos as $group) {
                                                                            ?>
                                                                            <option value="<?= $group['CodigoProdutoGrupo']; ?>"><?= $group['NomeProdutoGrupo']; ?></option>
                                                                            <?php
                                                                        }
                                                                    }
                                                                    ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="UnidadeProduto" type="text" id="UnidadeProduto" class="form-control" placeholder="Unidade do produto" />
                                                            </div>
                                                        </div>
                                                    </div>                                               
                                                </div>
