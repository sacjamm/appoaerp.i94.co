                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="<?= base_url('produtos/create'); ?>" class="btn btn-success btn-xs">
                                    <i class="fa fa-plus"></i> Novo
                                </a> 
                                Gerencie os produtos </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body"> 
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($produtos as $produto) {
                                            $button_edit = '<a href="' . base_url('produtos/edit/' . $produto['CodigoProduto']) . '" class=" btn-link text-primary"><i class="fas fa-edit"></i></a>';
                                            if (!hasPermission($userPermissions, 'eProduto')) {
                                                $button_edit = '';
                                            }
                                            $button_delete = '<a href="#" class=" btn-link text-danger delete-btn" data-id="' . $produto['CodigoProduto'] . '"><i class="fas fa-trash"></i></a>';
                                            if (!hasPermission($userPermissions, 'dProduto')) {
                                                $button_delete = '';
                                            }
                                            ?>
                                            <tr>
                                                ...
                                                <td><?= $produto['NomeProdutoGrupo']; ?></td>
...
function timeout_page(response,time){
    setTimeout(function () {
        ...
        function loadTable() {
            ...
            $('#permissionsTable').load('<?= base_url('produtos/getTableData'); ?>', function () {
