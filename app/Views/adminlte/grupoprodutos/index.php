            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Grupo de produtos</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="<?= base_url('grupoprodutos/create'); ?>" class="btn btn-success btn-xs">
                                    <i class="fa fa-plus"></i> Novo
                                </a> 
                                Gerencie os grupos </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body"> 
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function loadTable() {
            ...
            $('#permissionsTable').load('<?= base_url('grupoprodutos/getTableData'); ?>', function () {
        ...
        $('#confirmDelete').on('click', function () {
            $.ajax({
                url: '<?= site_url('grupoprodutos/delete') ?>',
                type: 'POST',
                data: {
                    id: deleteId,
                },
