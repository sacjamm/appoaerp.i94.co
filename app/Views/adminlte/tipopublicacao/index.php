...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Gerenciar tipos publicação</h1> 
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url(); ?>">Home</a></li>
                        <li class="breadcrumb-item active">Tipos publicação</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="<?= base_url('tipopublicacao/create'); ?>" class="btn btn-success btn-xs">
                                    <i class="fa fa-plus"></i> Novo
                                </a> 
                                Gerencie os tipos publicação </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function loadTable() {
            ...
            $('#permissionsTable').load('<?= base_url('tipopublicacao/getTableData'); ?>', function () {
        ...
        $('#confirmDelete').on('click', function () {
            $.ajax({
                url: '<?= site_url('tipopublicacao/delete') ?>',
                type: 'POST',
                data: {
                    id: deleteId,
                },
