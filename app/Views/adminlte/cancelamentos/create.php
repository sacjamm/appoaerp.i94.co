            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right"> 
                        ...
                        <li class="breadcrumb-item active">Adicionar motivo de cancelamento</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <form action="<?php echo base_url(); ?>cancelamentos/create" id="formCancelamento" method="post">
                            <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="NomeMotivoCancel" type="text" id="NomeMotivoCancel" class="form-control" placeholder="Descrição do motivo de cancelamento" />
                                                            </div>
                                                        </div>
                                                    </div>                                                
