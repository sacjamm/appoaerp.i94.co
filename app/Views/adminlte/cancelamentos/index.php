...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Gerenciar motivos de cancelamento</h1> 
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="<?= base_url('cancelamentos/create'); ?>" class="btn btn-success btn-xs">
                                    <i class="fa fa-plus"></i> Novo
                                </a> 
                                Gerencie os motivos de cancelamento </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function loadTable() {
            ...
            $('#permissionsTable').load('<?= base_url('cancelamentos/getTableData'); ?>', function () {
        ...
        $('#confirmDelete').on('click', function () {
            $.ajax({
                url: '<?= site_url('cancelamentos/delete') ?>',
                type: 'POST',
                data: {
                    id: deleteId,
                },
