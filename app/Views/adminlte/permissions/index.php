                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="<?= base_url('permissions/create'); ?>" class="btn btn-success btn-xs">
                                    <i class="fa fa-plus"></i> Novo
                                </a> 
                                Gerencie os níveis </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function loadTable() {
            ...
            $('#permissionsTable').load('<?= base_url('permissions/getTableData'); ?>', function () {
        ...
        $('#confirmDelete').on('click', function () {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    id: deleteId, // ID do registro que será excluído
                    [csrfName]: csrfHash // Enviar o token CSRF junto com a requisição
                },
