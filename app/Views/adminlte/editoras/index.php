                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="<?= base_url('editoras/create'); ?>" class="btn btn-success btn-xs">
                                    <i class="fa fa-plus"></i> Novo
                                </a> 
                                Gerencie as editoras </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function loadTable() {
            ...
            $('#permissionsTable').load('<?= base_url('editoras/getTableData'); ?>', function () {
