                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="<?= base_url('associados/create'); ?>" class="btn btn-success btn-xs">
                                    <i class="fa fa-plus"></i> Novo
                                </a> 
                                Gerencie os associados
                            </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="table_associados" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Nome</th>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#confirmDelete').on('click', function () {
            $.ajax({
                url: '<?= base_url('associados/delete') ?>',
                method: 'POST',
                data: { id: deleteId },
                success: function (response) {
                    modal.hide();
                    $('#table_associados').DataTable().ajax.reload();
