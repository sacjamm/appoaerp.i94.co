                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                Adicionar empresa</h3>
                        </div>
                        <!-- /.card-header -->
                        <form action="<?php echo base_url(); ?>empresas/create" id="formEmpresa" method="post">
                            <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="NomeEmpresa" type="text" id="NomeEmpresa" class="form-control" placeholder="Nome da empresa" required="required" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="CNPJEmpresa" type="tel" id="CICAssoc" class="form-control cnpj" placeholder="CNPJ da empresa" oninput="mascara_checkout(this, 'cnpj')" maxlength="18" />
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="CEPEmpresa" type="tel" id="CEPEmpresa" class="form-control cep" placeholder="CEP da empresa" oninput="mascara_checkout(this, 'cep')" maxlength="9" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="EnderecoEmpresa">Endereço</label>
                                                                <input name="EnderecoEmpresa" type="text" id="EnderecoEmpresa" class="form-control rua" placeholder="Endereço da empresa"/>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="BairroEmpresa">Bairro</label>
                                                                <input name="BairroEmpresa" type="text" id="BairroEmpresa" class="form-control bairro" placeholder="Bairro da empresa"/>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="CidadeEmpresa" type="text" id="CidadeEmpresa" class="form-control cidade" placeholder="Cidade da empresa" />
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="FoneEmpresa" type="tel" id="FoneEmpresa" class="form-control " placeholder="Telefone da empresa" oninput="mascara_checkout(this, 'tel')" maxlength="13" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="EMailEmpresa" type="email" id="EMailEmpresa" class="form-control " placeholder="E-mail da empresa" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="SiteEmpresa">Site <small class="text-danger">Ex.: https://meusite.com.br</small></label>
                                                                <input name="SiteEmpresa" type="url" id="SiteEmpresa" class="form-control " placeholder="Site da empresa" />
                                                            </div>
                                                        </div>
                                                    </div>
