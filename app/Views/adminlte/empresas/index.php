                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="<?= base_url('empresas/create'); ?>" class="btn btn-success btn-xs">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="table_empresas" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Nome</th>
