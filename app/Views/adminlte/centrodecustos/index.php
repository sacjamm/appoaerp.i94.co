...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Gerenciar centro de custo</h1> 
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="<?= base_url('centrodecustos/create'); ?>" class="btn btn-success btn-xs">
                                    <i class="fa fa-plus"></i> Novo
                                </a> 
                                Gerencie os centro de custos </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function loadTable() {
            ...
            $('#permissionsTable').load('<?= base_url('centrodecustos/getTableData'); ?>', function () {
        ...
        $('#confirmDelete').on('click', function () {
            $.ajax({
                url: '<?= site_url('centrodecustos/delete') ?>',
                type: 'POST',
                data: {
                    id: deleteId,
                },
